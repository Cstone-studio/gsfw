...
public class BuildQueryWrapper {
    ...
    /*********************** Orcale数据库相关 ******************************/
    public static <Entity> QueryWrapper<Entity> dateScopeOrcale(Date from, Date to, String field, QueryWrapper<Entity> queryWrapper){
    ...
    /*********************** Mysql数据库相关 ******************************/
    public static <Entity> QueryWrapper<Entity> dateScopeMySql(Date from, Date to, String field, QueryWrapper<Entity> queryWrapper){
